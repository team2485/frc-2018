...
public class RobotMap {
	...
	public static final int sonicPingPort = 0;
	public static final int sonicEchoPort = 1;
	...
	public static void init() {
		...
		driveTalons = new TalonSRX[] { driveLeftTalon, driveRightTalon };
		...
		// sonic = new Ultrasonic(sonicPingPort, sonicEchoPort, Unit.kInches);

		deadReckoning = new DeadReckoning(pigeonDisplacementWrapper, driveLeftEncoderWrapperDistance,
				driveRightEncoderWrapperDistance);
